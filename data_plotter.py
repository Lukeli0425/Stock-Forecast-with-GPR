...
class Plotter:
    ...
    def __init__(self, company_name: str):
        ...
        self.__company_handler = data_handler.CsvHandler(company_name)   # 整理并获取csv文件中数据
    ...
    def show_preprocessed_prices(self, start_year: int, end_year: int):
        ...
        fig.savefig("./Results/"+self.__company_name+"/"+fname, dpi=fig.dpi)
        plt.clf()
    ...
    def show_whole_time_series(self, intermediate: bool = False):
        ...
        # 起始年为years[0], 终止点为years[-1]，这个用法很好
